    ...
    return (
        <div className={classes.widePanel}>
            <section className={classes.section}>
                <header className={classes.header}>{t('DetailsPanel.PROPERTIES_TITLE')}</header>
            ...
            <section className={mergeClasses(classes.section, classes.wideSection)}>
                <header className={classes.header}>{t('DetailsPanel.OBJECTS_TITLE')}</header>
                <div className={classes.scrollable}>
                    <SceneObjectsPanel />
                </div>
            </section>
    ...
    return (
        <div className={classes.wrapper}>
            <TabList selectedValue={tab} onTabSelect={(ev, data) => setTab(data.value)}>
                <Tab value={Tabs.Properties}>{t('DetailsPanel.PROPERTIES_TITLE')}</Tab>
                <Tab value={Tabs.Objects}>{t('DetailsPanel.OBJECTS_TITLE')}</Tab>
            </TabList>
