...
const JOBS: Record<Job, JobProps> = {
    ...
    [Job.RoleTank1]: { name: 'Tank 1', icon: 'tank1.png' },
    [Job.RoleTank2]: { name: 'Tank 2', icon: 'tank2.png' },
    [Job.RoleHealer]: { name: 'Healer', icon: 'healer.png' },
    [Job.RoleHealer1]: { name: 'Healer 1', icon: 'healer1.png' },
    [Job.RoleHealer2]: { name: 'Healer 2', icon: 'healer2.png' },
    [Job.RolePureHealer]: { name: 'Pure Healer', icon: 'pure_healer.png' },
    [Job.RoleBarrierHealer]: { name: 'Barrier Healer', icon: 'barrier_healer.png' },
    [Job.RoleSupport]: { name: 'Support', icon: 'support.png' },
    [Job.RoleDps]: { name: 'DPS', icon: 'dps.png' },
    [Job.RoleDps1]: { name: 'DPS 1', icon: 'dps1.png' },
    [Job.RoleDps2]: { name: 'DPS 2', icon: 'dps2.png' },
    [Job.RoleDps3]: { name: 'DPS 3', icon: 'dps3.png' },
    [Job.RoleDps4]: { name: 'DPS 4', icon: 'dps4.png' },
    [Job.RoleMelee]: { name: 'Melee DPS', icon: 'melee.png' },
    [Job.RoleMelee1]: { name: 'Melee DPS 1', icon: 'melee1.png' },
    [Job.RoleMelee2]: { name: 'Melee DPS 2', icon: 'melee2.png' },
    [Job.RoleRanged]: { name: 'Ranged DPS', icon: 'ranged.png' },
    [Job.RoleRanged1]: { name: 'Ranged DPS 1', icon: 'ranged1.png' },
    [Job.RoleRanged2]: { name: 'Ranged DPS 2', icon: 'ranged2.png' },
